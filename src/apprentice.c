...
const struct ApprenticeTrainer gApprentices[] =
{
    ...
    },
    {
        ...
        .otId = 0xCF09,
        .facilityClass = 0x2B,
        .species = {SPECIES_SWELLOW, SPECIES_CRESSELIA, SPECIES_MEDIREIGN, SPECIES_MANECTRIC, SPECIES_SANDSLASH_A, SPECIES_CRUSTLE, SPECIES_MIGHTYENA, SPECIES_PANGORO, SPECIES_CRAWDAUNT, SPECIES_LAMPENT},
        .id = 1,
    ...
    },
    {
        ...
        .otId = 0x469f,
        .facilityClass = 0,
        .species = {SPECIES_SKARMORY, SPECIES_MEOWSTIC_F, SPECIES_BLAZIKEN, SPECIES_PORYGON_Z, SPECIES_PYROAR, SPECIES_MUDSDALE, SPECIES_SALAMENCE, SPECIES_KYUREM, SPECIES_TIRTOUGA, SPECIES_RHYDON},
        .id = 9,
    ...
    },
    {
        ...
        .otId = 0xE590,
        .facilityClass = 0x19,
        .species = {SPECIES_ABSOL, SPECIES_LEAVANNY, SPECIES_ZYGARDE, SPECIES_MAGNETON, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_SCRAFTY, SPECIES_SANDSHREW_A, SPECIES_EMOLGA},
        .id = 12,
    ...
    },
    {
        ...
        .otId = 0xBC75,
        .facilityClass = 14,
        .species = {SPECIES_SCEPTILE, SPECIES_SANDSLASH, SPECIES_FLYGON, SPECIES_GIGALITH, SPECIES_ARMALDO, SPECIES_LEAVANNY, SPECIES_CRADILY, SPECIES_TIRTOUGA, SPECIES_FROSLASS, SPECIES_MEOWSTIC_F},
        .id = 14,
