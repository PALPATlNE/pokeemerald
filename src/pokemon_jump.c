...
static const struct PokemonJumpMons gPkmnJumpSpecies[] =
{
    ...
    { .species = SPECIES_WIMPOD,   .unk2 = 0, },
    { .species = SPECIES_SEWADDLE,   .unk2 = 1, },
    { .species = SPECIES_FOONGUS,      .unk2 = 0, },
    { .species = SPECIES_AMOONGUSS,     .unk2 = 0, },
    { .species = SPECIES_MIMIKYU,  .unk2 = 2, },
    ...
    { .species = SPECIES_DUOSIS,      .unk2 = 2, },
    { .species = SPECIES_PANCHAM,     .unk2 = 1, },
