...
// tentative name
const u8 gBiasTags[] = {
  SLOT_MACHINE_TAG_REPLAY, SLOT_MACHINE_TAG_CHERRY, SLOT_MACHINE_TAG_DUOSIS, SLOT_MACHINE_TAG_CARRACOSTA, SLOT_MACHINE_TAG_POWER, SLOT_MACHINE_TAG_7_RED, SLOT_MACHINE_TAG_7_RED, SLOT_MACHINE_TAG_7_RED
};
...
const u16 gLuckyFlagSettings_NotTop3[] = {
    LUCKY_BIAS_POWER, LUCKY_BIAS_CARRACOSTA, LUCKY_BIAS_DUOSIS, LUCKY_BIAS_CHERRY, LUCKY_BIAS_REPLAY
};
