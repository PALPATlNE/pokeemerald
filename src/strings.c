...
const u8 gText_ThisIsAPokemon[] = _("This region is inhabited by:\n{PAUSE 96}Creatures known as Pokémon.\p");
...
const u8 gText_LillipupBerryPicking[] = _("LILLIPUP BERRY-PICKING");
...
const u8 gText_GothitaDoll32BP[] = _("GOTHITA DOLL{CLEAR_TO 0x5E}32BP");
const u8 gText_TogepiDoll48BP[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_TyruntDoll48BP[] = _("TYRUNT DOLL{CLEAR_TO 0x5E}48BP");
...
const u8 gText_SnoverDoll80BP[] = _("SNOVER DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_WimpodDoll80BP[] = _("WIMPOD DOLL{CLEAR_TO 0x5E}80BP");
