static const struct TrainerMonNoItemDefaultMoves sParty_Clair1[] = {
     {
    .iv = 0,
    .lvl = 12,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZaurakBridgeDerek_Torchic[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZaurakBridgeDerek_Froakie[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZaurakBridgeDerek_Snivy[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZaurakBridgeKate_Torchic[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TORCHIC,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZaurakBridgeKate_Froakie[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_FROAKIE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ZaurakBridgeKate_Snivy[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_SNIVY,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Clair_Route02[] = {
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_CLEFAIRY,
