const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_SCRAGGY] = sHorseaLevelUpLearnset,
    [SPECIES_SCRAFTY] = sSeadraLevelUpLearnset,
    [SPECIES_DRILBUR] = sGoldeenLevelUpLearnset,
    ...
    [SPECIES_BUIZEL] = sMagmarLevelUpLearnset,
    [SPECIES_PINSIR] = sPinsirLevelUpLearnset,
    [SPECIES_FLOATZEL] = sTaurosLevelUpLearnset,
    ...
    [SPECIES_WIMPOD] = sTotodileLevelUpLearnset,
    [SPECIES_GOLISOPOD] = sCroconawLevelUpLearnset,
    [SPECIES_BASCULIN] = sFeraligatrLevelUpLearnset,
    ...
    [SPECIES_SEWADDLE] = sSpinarakLevelUpLearnset,
    [SPECIES_SWADLOON] = sAriadosLevelUpLearnset,
    [SPECIES_LEAVANNY] = sCrobatLevelUpLearnset,
    [SPECIES_CHINCHOU] = sChinchouLevelUpLearnset,
    [SPECIES_LANTURN] = sLanturnLevelUpLearnset,
    [SPECIES_FOONGUS] = sPichuLevelUpLearnset,
    [SPECIES_AMOONGUSS] = sCleffaLevelUpLearnset,
    [SPECIES_MIMIKYU] = sIgglybuffLevelUpLearnset,
    ...
    [SPECIES_PYROAR] = sDonphanLevelUpLearnset,
    ...
    [SPECIES_DUOSIS] = sLotadLevelUpLearnset,
    [SPECIES_REUNICLUS] = sLombreLevelUpLearnset,
    [SPECIES_PANGORO] = sLudicoloLevelUpLearnset,
    [SPECIES_PANCHAM] = sSeedotLevelUpLearnset,
    ...
    [SPECIES_PORYGON_Z] = sCameruptLevelUpLearnset,
    ...
    [SPECIES_TIMBURR] = sWynautLevelUpLearnset,
