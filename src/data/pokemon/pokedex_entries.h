const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_MEOWSTIC_M] =
    {
        ...
        .height = 10,
        .weight = 1050,
        .description = gMeowstic_MalePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEOWSTIC_F] =
    {
        ...
        .height = 14,
        .weight = 3000,
        .description = gMeowstic_FemalePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_DUOSIS] =
    {
        ...
        .height = 5,
        .weight = 26,
        .description = gDuosisPokedexText,
        .pokemonScale = 406,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SANDSHREW_A] =
    {
        ...
        .height = 10,
        .weight = 970,
        .description = gSandshrew_APokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 9,
        .trainerScale = 289,
        .trainerOffset = 3,
    ...
    [NATIONAL_DEX_SANDSLASH_A] =
    {
        ...
        .height = 5,
        .weight = 804,
        .description = gSandslash_APokedexText,
        .pokemonScale = 390,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FILLER3] =
    {
        .categoryName = _("WEATHER"),
        .height = 3,
        .weight = 8,
        .description = gFiller3PokedexText,
        .pokemonScale = 435,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
