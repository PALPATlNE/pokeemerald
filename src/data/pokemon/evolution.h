const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PSYDUCK]    = {{EVO_LEVEL, 33, SPECIES_VESPIQUEEN}},
    ...
    [SPECIES_SCRAFTY]     = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_HOUNDREAD}},
    [SPECIES_DRILBUR]    = {{EVO_LEVEL, 33, SPECIES_EXCADRILL}},
    ...
    [SPECIES_WIMPOD]   = {{EVO_LEVEL, 18, SPECIES_GOLISOPOD}},
    [SPECIES_GOLISOPOD]   = {{EVO_LEVEL, 30, SPECIES_BASCULIN}},
    ...
    [SPECIES_SEWADDLE]   = {{EVO_LEVEL, 22, SPECIES_SWADLOON}},
    [SPECIES_CHINCHOU]   = {{EVO_LEVEL, 27, SPECIES_LANTURN}},
    [SPECIES_FOONGUS]      = {{EVO_FRIENDSHIP, 0, SPECIES_PIKACHU}},
    [SPECIES_AMOONGUSS]     = {{EVO_FRIENDSHIP, 0, SPECIES_CLEFAIRY}},
    [SPECIES_MIMIKYU]  = {{EVO_FRIENDSHIP, 0, SPECIES_FROAKIE}},
    ...
    [SPECIES_GOTHITELLE]      = {{EVO_LEVEL, 30, SPECIES_BUIZEL}},
    ...
    [SPECIES_PETILIL]    = {{EVO_LEVEL_SILCOON, 7, SPECIES_LILLIGANT},
                            {EVO_LEVEL_CASCOON, 7, SPECIES_WHIMSICOTT}},
    [SPECIES_LILLIGANT]    = {{EVO_LEVEL, 10, SPECIES_COTTONEE}},
    [SPECIES_WHIMSICOTT]    = {{EVO_LEVEL, 10, SPECIES_SOLOSIS}},
    [SPECIES_DUOSIS]      = {{EVO_LEVEL, 14, SPECIES_REUNICLUS}},
    [SPECIES_REUNICLUS]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_PANGORO}},
    [SPECIES_PANCHAM]     = {{EVO_LEVEL, 14, SPECIES_MIENFOO}},
    [SPECIES_MIENFOO]    = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_MIENSHAO}},
    [SPECIES_AMAURA]    = {{EVO_LEVEL_NINJASK, 20, SPECIES_AURORUS},
                            {EVO_LEVEL_SHEDINJA, 20, SPECIES_DIALGA}},
    ...
    [SPECIES_MANETHUNDR]      = {{EVO_LEVEL, 33, SPECIES_PORYGON_Z}},
    ...
    [SPECIES_DARKRAI]     = {{EVO_LEVEL, 26, SPECIES_SWALOT}},
