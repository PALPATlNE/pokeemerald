const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_SCRAGGY] = gMonFootprint_Horsea,
    [SPECIES_SCRAFTY] = gMonFootprint_Seadra,
    [SPECIES_DRILBUR] = gMonFootprint_Goldeen,
    ...
    [SPECIES_BUIZEL] = gMonFootprint_Magmar,
    [SPECIES_PINSIR] = gMonFootprint_Pinsir,
    [SPECIES_FLOATZEL] = gMonFootprint_Tauros,
    ...
    [SPECIES_WIMPOD] = gMonFootprint_Totodile,
    [SPECIES_GOLISOPOD] = gMonFootprint_Croconaw,
    [SPECIES_BASCULIN] = gMonFootprint_Feraligatr,
    ...
    [SPECIES_SEWADDLE] = gMonFootprint_Spinarak,
    [SPECIES_SWADLOON] = gMonFootprint_Ariados,
    [SPECIES_LEAVANNY] = gMonFootprint_Crobat,
    [SPECIES_CHINCHOU] = gMonFootprint_Chinchou,
    [SPECIES_LANTURN] = gMonFootprint_Lanturn,
    [SPECIES_FOONGUS] = gMonFootprint_Pichu,
    [SPECIES_AMOONGUSS] = gMonFootprint_Cleffa,
    [SPECIES_MIMIKYU] = gMonFootprint_Igglybuff,
    ...
    [SPECIES_PYROAR] = gMonFootprint_Donphan,
    ...
    [SPECIES_DUOSIS] = gMonFootprint_Lotad,
    [SPECIES_REUNICLUS] = gMonFootprint_Lombre,
    [SPECIES_PANGORO] = gMonFootprint_Ludicolo,
    [SPECIES_PANCHAM] = gMonFootprint_Seedot,
    ...
    [SPECIES_PORYGON_Z] = gMonFootprint_Camerupt,
    ...
    [SPECIES_TIMBURR] = gMonFootprint_Wynaut,
