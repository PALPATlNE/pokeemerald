const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MEOWSTIC_M, gMonFrontPic_Meowstic_Male),
    SPECIES_SPRITE(MEOWSTIC_F, gMonFrontPic_Meowstic_Female),
    ...
    SPECIES_SPRITE(FLABEBE, gMonFrontPic_FlabebeA),
    ...
    SPECIES_SPRITE(OLD_FLABEBE_B, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_C, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_D, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_E, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_F, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_G, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_H, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_I, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_J, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_K, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_L, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_M, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_N, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_O, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_P, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_Q, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_R, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_S, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_T, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_U, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_V, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_W, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_X, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_Y, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(OLD_FLABEBE_Z, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(DUOSIS, gMonFrontPic_Duosis),
    ...
    SPECIES_SPRITE(SANDSHREW_A, gMonFrontPic_Sandshrew_A),
    SPECIES_SPRITE(SANDSLASH_A, gMonFrontPic_Sandslash_A),
    ...
    SPECIES_SPRITE(FILLER3, gMonFrontPic_Filler3),
    ...
    SPECIES_SPRITE(FLABEBE_B, gMonFrontPic_FlabebeB),
    SPECIES_SPRITE(FLABEBE_C, gMonFrontPic_FlabebeC),
    SPECIES_SPRITE(FLABEBE_D, gMonFrontPic_FlabebeD),
    SPECIES_SPRITE(FLABEBE_E, gMonFrontPic_FlabebeE),
    SPECIES_SPRITE(FLABEBE_F, gMonFrontPic_FlabebeF),
    SPECIES_SPRITE(FLABEBE_G, gMonFrontPic_FlabebeG),
    SPECIES_SPRITE(FLABEBE_H, gMonFrontPic_FlabebeH),
    SPECIES_SPRITE(FLABEBE_I, gMonFrontPic_FlabebeI),
    SPECIES_SPRITE(FLABEBE_J, gMonFrontPic_FlabebeJ),
    SPECIES_SPRITE(FLABEBE_K, gMonFrontPic_FlabebeK),
    SPECIES_SPRITE(FLABEBE_L, gMonFrontPic_FlabebeL),
    SPECIES_SPRITE(FLABEBE_M, gMonFrontPic_FlabebeM),
    SPECIES_SPRITE(FLABEBE_N, gMonFrontPic_FlabebeN),
    SPECIES_SPRITE(FLABEBE_O, gMonFrontPic_FlabebeO),
    SPECIES_SPRITE(FLABEBE_P, gMonFrontPic_FlabebeP),
    SPECIES_SPRITE(FLABEBE_Q, gMonFrontPic_FlabebeQ),
    SPECIES_SPRITE(FLABEBE_R, gMonFrontPic_FlabebeR),
    SPECIES_SPRITE(FLABEBE_S, gMonFrontPic_FlabebeS),
    SPECIES_SPRITE(FLABEBE_T, gMonFrontPic_FlabebeT),
    SPECIES_SPRITE(FLABEBE_U, gMonFrontPic_FlabebeU),
    SPECIES_SPRITE(FLABEBE_V, gMonFrontPic_FlabebeV),
    SPECIES_SPRITE(FLABEBE_W, gMonFrontPic_FlabebeW),
    SPECIES_SPRITE(FLABEBE_X, gMonFrontPic_FlabebeX),
    SPECIES_SPRITE(FLABEBE_Y, gMonFrontPic_FlabebeY),
    SPECIES_SPRITE(FLABEBE_Z, gMonFrontPic_FlabebeZ),
    SPECIES_SPRITE(FLABEBE_EMARK, gMonFrontPic_FlabebeExclamationMark),
    SPECIES_SPRITE(FLABEBE_QMARK, gMonFrontPic_FlabebeQuestionMark),
};
