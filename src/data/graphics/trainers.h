...
const u32 gTrainerFrontPic_BidoofolLady[] = INCBIN_U32("graphics/trainers/front_pics/parasol_lady_front_pic.4bpp.lz");
const u32 gTrainerPalette_BidoofolLady[] = INCBIN_U32("graphics/trainers/palettes/parasol_lady.gbapal.lz");
