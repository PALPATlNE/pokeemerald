...
const u16 DecorGfx_WIMPOD_DOLL[] = {
    EVENT_OBJ_GFX_WIMPOD_DOLL
};
...
const u16 DecorGfx_DUOSIS_DOLL[] = {
    EVENT_OBJ_GFX_DUOSIS_DOLL
};

const u16 DecorGfx_PANCHAM_DOLL[] = {
    EVENT_OBJ_GFX_PANCHAM_DOLL
};
