...
{
    // Level 50
    {FRONTIER_MON_BULBASAUR,  FRONTIER_MON_FURRET_1},   // 110 - 199
    {FRONTIER_MON_DELCATTY_1, FRONTIER_MON_SWANNA_1}, // 162 - 266
    {FRONTIER_MON_DELCATTY_2, FRONTIER_MON_SWANNA_2}, // 267 - 371
    {FRONTIER_MON_ESCAVALIER_1,  FRONTIER_MON_TALONFLAME_1},  // 372 - 467
    {FRONTIER_MON_ESCAVALIER_2,  FRONTIER_MON_TALONFLAME_2},  // 468 - 563
    {FRONTIER_MON_ESCAVALIER_3,  FRONTIER_MON_TALONFLAME_3},  // 564 - 659
    {FRONTIER_MON_ESCAVALIER_4,  FRONTIER_MON_TALONFLAME_4},  // 660 - 755
    {FRONTIER_MON_ESCAVALIER_1,  FRONTIER_MONS_HIGH_TIER}, // 372 - 849
    ...
    {FRONTIER_MON_ESCAVALIER_3, FRONTIER_MON_TALONFLAME_3}, // 564 - 659
    {FRONTIER_MON_ESCAVALIER_4, FRONTIER_MON_TALONFLAME_4}, // 660 - 755
    {FRONTIER_MON_ESCAVALIER_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_ESCAVALIER_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_ESCAVALIER_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_ESCAVALIER_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
};
...
static void GenerateOpponentMons(void)
{
    ...
    while (i != FRONTIER_PARTY_SIZE)
    {
        ...
        if (gFacilityTrainerMons[monId].species == SPECIES_FLABEBE)
            continue;
