...
const u16 gSpeciesToHoennPokedexNum[] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(OLD_FLABEBE_B),
    SPECIES_TO_HOENN(OLD_FLABEBE_C),
    SPECIES_TO_HOENN(OLD_FLABEBE_D),
    SPECIES_TO_HOENN(OLD_FLABEBE_E),
    SPECIES_TO_HOENN(OLD_FLABEBE_F),
    SPECIES_TO_HOENN(OLD_FLABEBE_G),
    SPECIES_TO_HOENN(OLD_FLABEBE_H),
    SPECIES_TO_HOENN(OLD_FLABEBE_I),
    SPECIES_TO_HOENN(OLD_FLABEBE_J),
    SPECIES_TO_HOENN(OLD_FLABEBE_K),
    SPECIES_TO_HOENN(OLD_FLABEBE_L),
    SPECIES_TO_HOENN(OLD_FLABEBE_M),
    SPECIES_TO_HOENN(OLD_FLABEBE_N),
    SPECIES_TO_HOENN(OLD_FLABEBE_O),
    SPECIES_TO_HOENN(OLD_FLABEBE_P),
    SPECIES_TO_HOENN(OLD_FLABEBE_Q),
    SPECIES_TO_HOENN(OLD_FLABEBE_R),
    SPECIES_TO_HOENN(OLD_FLABEBE_S),
    SPECIES_TO_HOENN(OLD_FLABEBE_T),
    SPECIES_TO_HOENN(OLD_FLABEBE_U),
    SPECIES_TO_HOENN(OLD_FLABEBE_V),
    SPECIES_TO_HOENN(OLD_FLABEBE_W),
    SPECIES_TO_HOENN(OLD_FLABEBE_X),
    SPECIES_TO_HOENN(OLD_FLABEBE_Y),
    SPECIES_TO_HOENN(OLD_FLABEBE_Z),
...
const u16 gSpeciesToNationalPokedexNum[] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(OLD_FLABEBE_B),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_C),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_D),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_E),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_F),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_G),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_H),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_I),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_J),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_K),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_L),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_M),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_N),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_O),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_P),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_Q),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_R),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_S),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_T),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_U),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_V),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_W),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_X),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_Y),
    SPECIES_TO_NATIONAL(OLD_FLABEBE_Z),
...
const u16 gHoennToNationalOrder[] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(OLD_FLABEBE_B),
    HOENN_TO_NATIONAL(OLD_FLABEBE_C),
    HOENN_TO_NATIONAL(OLD_FLABEBE_D),
    HOENN_TO_NATIONAL(OLD_FLABEBE_E),
    HOENN_TO_NATIONAL(OLD_FLABEBE_F),
    HOENN_TO_NATIONAL(OLD_FLABEBE_G),
    HOENN_TO_NATIONAL(OLD_FLABEBE_H),
    HOENN_TO_NATIONAL(OLD_FLABEBE_I),
    HOENN_TO_NATIONAL(OLD_FLABEBE_J),
    HOENN_TO_NATIONAL(OLD_FLABEBE_K),
    HOENN_TO_NATIONAL(OLD_FLABEBE_L),
    HOENN_TO_NATIONAL(OLD_FLABEBE_M),
    HOENN_TO_NATIONAL(OLD_FLABEBE_N),
    HOENN_TO_NATIONAL(OLD_FLABEBE_O),
    HOENN_TO_NATIONAL(OLD_FLABEBE_P),
    HOENN_TO_NATIONAL(OLD_FLABEBE_Q),
    HOENN_TO_NATIONAL(OLD_FLABEBE_R),
    HOENN_TO_NATIONAL(OLD_FLABEBE_S),
    HOENN_TO_NATIONAL(OLD_FLABEBE_T),
    HOENN_TO_NATIONAL(OLD_FLABEBE_U),
    HOENN_TO_NATIONAL(OLD_FLABEBE_V),
    HOENN_TO_NATIONAL(OLD_FLABEBE_W),
    HOENN_TO_NATIONAL(OLD_FLABEBE_X),
    HOENN_TO_NATIONAL(OLD_FLABEBE_Y),
    HOENN_TO_NATIONAL(OLD_FLABEBE_Z),
};

const struct PalkiaSpot gPalkiaSpotGraphics[] =
{
...
static const u8 sMonFrontAnimIdsTable[] =
{
    ...
    [SPECIES_SPINARAK - 1] = 0x12,
    [SPECIES_ARIADOS - 1] = 0x04,
    [SPECIES_DRILBUR - 1] = 0x0d,
    ...
    [SPECIES_BUIZEL - 1] = 0x0f,
    [SPECIES_PINSIR - 1] = 0x09,
    [SPECIES_FLOATZEL - 1] = 0x19,
    ...
    [SPECIES_WIMPOD - 1] = 0x31,
    [SPECIES_GOLISOPOD - 1] = 0x0f,
    [SPECIES_BASCULIN - 1] = 0x0f,
    ...
    [SPECIES_SEWADDLE - 1] = 0x4f,
    [SPECIES_SWADLOON - 1] = 0x0f,
    [SPECIES_LEAVANNY - 1] = 0x00,
    [SPECIES_CHINCHOU - 1] = 0x45,
    [SPECIES_LANTURN - 1] = 0x51,
    [SPECIES_FOONGUS - 1] = 0x1e,
    [SPECIES_AMOONGUSS - 1] = 0x52,
    [SPECIES_MIMIKYU - 1] = 0x0c,
    ...
    [SPECIES_OLD_FLABEBE_B - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_C - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_D - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_E - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_F - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_G - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_H - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_I - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_J - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_K - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_L - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_M - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_N - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_O - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_P - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_Q - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_R - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_S - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_T - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_U - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_V - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_W - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_X - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_Y - 1] = 0x00,
    [SPECIES_OLD_FLABEBE_Z - 1] = 0x00,
    ...
    [SPECIES_DUOSIS - 1] = 0x00,
    [SPECIES_REUNICLUS - 1] = 0x00,
    [SPECIES_PANGORO - 1] = 0x49,
    [SPECIES_PANCHAM - 1] = 0x05,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_FLOATZEL - 1] = 0x0a,
    [SPECIES_TYPHLOSION - 1] = 0x14,
    [SPECIES_BASCULIN - 1] = 0x05,
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (attackerHoldEffect == HOLD_EFFECT_DEEP_SEA_TOOTH && attacker->species == SPECIES_AZELF)
        spAttack *= 2;
    if (defenderHoldEffect == HOLD_EFFECT_DEEP_SEA_SCALE && defender->species == SPECIES_AZELF)
        spDefense *= 2;
...
void sub_806D544(u16 species, u32 personality, u8 *dest)
{
        ...
        && dest != gMonSpritesGfxPtr->sprites[2])
    {
        ...
        {
            int j;
            u8 x = gPalkiaSpotGraphics[i].x + ((personality & 0x0F) - 8);
            u8 y = gPalkiaSpotGraphics[i].y + (((personality & 0xF0) >> 4) - 8);

            for (j = 0; j < 16; j++)
            {
                int k;
                s32 row = gPalkiaSpotGraphics[i].image[j];
