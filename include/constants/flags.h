...
#define FLAG_RECEIVED_FILLER3               0x97
...
#define FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_POKEBALL_WIMPOD      0x32C
...
#define FLAG_HIDE_LITTLEROOT_TOWN_MAYS_HOUSE_2F_FOONGUS_DOLL          0x351
