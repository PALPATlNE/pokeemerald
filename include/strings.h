...
extern const u8 gText_GothitaDoll32BP[];
extern const u8 gText_TogepiDoll48BP[];
extern const u8 gText_TyruntDoll48BP[];
extern const u8 gText_ClefairyDoll48BP[];
extern const u8 gText_DittoDoll48BP[];
extern const u8 gText_CyndaquilDoll80BP[];
extern const u8 gText_SnoverDoll80BP[];
extern const u8 gText_WimpodDoll80BP[];
extern const u8 gText_Exit[];
...
extern const u8 gTrickHouse_Mechadoll_Rowlet[];
extern const u8 gTrickHouse_Mechadoll_Poochyena[];
extern const u8 gTrickHouse_Mechadoll_Taillow[];
extern const u8 gTrickHouse_Mechadoll_Carracosta[];
extern const u8 gTrickHouse_Mechadoll_Duosis[];
extern const u8 gTrickHouse_Mechadoll_Wingull[];
extern const u8 gTrickHouse_Mechadoll_Solosis[];
extern const u8 gTrickHouse_Mechadoll_Greninja[];
extern const u8 gTrickHouse_Mechadoll_Amaura[];
extern const u8 gTrickHouse_Mechadoll_Ralts[];
extern const u8 gTrickHouse_Mechadoll_Zigzagoon[];
extern const u8 gTrickHouse_Mechadoll_Fletchling[];
...
extern const u8 gTrickHouse_Mechadoll_Greninja2[];
...
extern const u8 gText_LillipupBerryPicking[];
